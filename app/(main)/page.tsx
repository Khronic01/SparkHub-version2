      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
            <div className="p-6 border-b border-slate-100 flex justify-between items-center">
                ...
                <Link href="/marketplace" className="text-sm text-blue-600 font-medium hover:underline">View all</Link>
            </div>
            <div className="divide-y divide-slate-100">
                {[1, 2, 3].map((i) => (
                    <Link key={i} href={`/ideas/${i}`} className="block p-6 hover:bg-slate-50 transition-colors group">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
                <Link href="/ideas/create" className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-slate-200 rounded-xl hover:border-blue-500 hover:bg-blue-50 transition-all text-slate-600 hover:text-blue-600">
                    <Lightbulb className="mb-2" />
                    <span className="font-medium">Post Idea</span>
                </Link>
                <Link href="/messages" className="flex flex-col items-center justify-center p-6 border-2 border-dashed border-slate-200 rounded-xl hover:border-purple-500 hover:bg-purple-50 transition-all text-slate-600 hover:text-purple-600">
