  ...
  return (
    <div className="max-w-3xl mx-auto animate-fade-in">
        <div className="flex items-center justify-between mb-8">
            ...
            <Link href="/marketplace" className="px-4 py-2 bg-white border border-slate-200 rounded-lg text-sm font-medium hover:bg-slate-50 transition-colors">
                Find People
            </Link>
        </div>
            ...
            {loading ? (
                ...
                <div className="bg-white p-12 rounded-xl border border-slate-200 text-center">
                    ...
                    <div className="flex justify-center gap-4">
                        <Link href="/marketplace" className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700">Explore Ideas</Link>
                    </div>
                </div>
            ) : (
                            ...
                            <div className="flex gap-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="mt-3 flex items-center gap-4">
                                        <Link href={item.link} className="text-sm font-medium text-blue-600 hover:underline flex items-center gap-1">
                                            View Details
                                        </Link>
                                        {item.meta && (
