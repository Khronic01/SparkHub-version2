...
import { CheckSquare, Clock, ArrowRight, AlertCircle, Briefcase, DollarSign } from 'lucide-react';
    ...
    <div className="animate-fade-in">
      ...
      {loading ? (
        ...
        <div className="bg-white p-12 rounded-xl border border-slate-200 text-center">
          ...
          <Link to="/marketplace" className="inline-block px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium">
